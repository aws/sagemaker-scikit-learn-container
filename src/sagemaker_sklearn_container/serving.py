...
def main(environ, start_response):
    ...
    if app is None:
        ...
        user_module_transformer, execution_parameter_fn = import_module(serving_env.module_name, serving_env.module_dir)

        app = worker.Worker(transform_fn=user_module_transformer.transform,
                            module_name=serving_env.module_name,
                            execution_paramters_fn=execution_parameter_fn)
